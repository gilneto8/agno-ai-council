...
REVIEWER_INSTRUCTIONS = [
    ...
    "4. Final Summary: Provide a friendly summary of what was built, and include the project's name.",
    "5. Make sure there is a README.md file with instructions on how to run the project.",
    "",
    "CRITICAL RULES:",
