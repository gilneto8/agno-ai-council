...
BACKEND_INSTRUCTIONS = [
    ...
    "5. Run a build command to ensure everything compiles. Make sure not to use any commands that block the prompt.",
...
REVIEWER_INSTRUCTIONS = [
    ...
    "2. Verification: Check that imports reference files that exist.",
    "3. Make sure there is a README.md file with instructions on how to run the project and the context provided in the user request (including motivation provided by the user).",
    "4. Create a text file called project_name.txt that ONLY contains the name given to the folder containing the project.",
    "5. Final Summary: Provide a friendly summary of what was built. Make sure this summary is your ONLY output.",
    "",
    "CRITICAL RULES:",
